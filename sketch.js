...
var bg,ground,gimg, christTree,tree;
...
function preload(){
  ...
  christTree=loadImage("christmasTree.png");
...
function setup() {
  ...
  tree=createSprite(1100,380);
  tree.addImage(christTree);
  tree.scale=0.7;
...
function draw() {
  ...
  textSize(50);
  fill("pink")
  text("Christmas Night ",100,100);
  textSize(30);
  text("Snowfall Animation",110,140);
